...
생명정보학 연구에서는 여러 데이터베이스와 도구를 통합적으로 활용하는 것이 중요하다. 유전체 데이터, 변이 정보, 표현형 정보, 단백질 구조, 생물학적 경로 등 다양한 데이터를 종합적으로 분석함으로써 생명 현상의 복잡한 메커니즘을 이해할 수 있다.
...
이러한 통합적 접근은 생명정보학 연구의 핵심이며, 의생명정보학의 궁극적 목표인 유전형에서 표현형을 예측하는 데 중요한 역할을 한다.
