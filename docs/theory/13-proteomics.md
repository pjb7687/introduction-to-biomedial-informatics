...
**Figure 13.5** HPLC 시스템 - 고성능 액체 크로마토그래피를 이용한 단백질 분리 시스템

![질량분석기](../assets/images/ms.png)

**Figure 13.6** 질량분석기 - 생체분자 분석을 위한 질량분석기의 기본 구성

![질량분석법 과정](../assets/images/mass-spectrometry.png)

**Figure 13.7** 질량분석법 과정 - 시료의 이온화부터 검출까지 전체적인 질량분석 과정
...
**Figure 13.8** MALDI 이미징 - 조직 절편에서 분자의 공간적 분포를 시각화하는 MALDI 이미징 기술
...
**Figure 13.9** 질량 세포분석법 - CyTOF를 이용한 단일세포 수준 다중 단백질 분석 원리
...
**Figure 13.10** CODEX 결과 - CODEX 기술을 이용한 다중 단백질 공간 이미징 결과
...
**Figure 13.11** 다나카 고이치 - 생체고분자의 질량분석법 개발로 2002년 노벨 화학상을 수상한 다나카 고이치
